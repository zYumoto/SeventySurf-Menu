      ...
      <MotionReveal>
        ...
        <div className="mt-8 flex min-h-[280px] items-center justify-center rounded-lg border border-white/10 bg-[linear-gradient(135deg,rgba(255,255,255,0.06),rgba(40,115,118,0.16))] p-6 text-center">
          <div>
            ...
            <p className="mt-4 font-display text-2xl font-bold text-white">{copy.contact.mapTitle}</p>
            <p className="mt-2 max-w-sm text-sm leading-6 text-white/[0.58]">{copy.contact.mapDescription}</p>
          </div>
        </div>
      </MotionReveal>
